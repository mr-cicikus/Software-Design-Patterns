...
-- Table Sessions (tracking customers at a table)
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    order_type VARCHAR(20), -- initial, additional
    created_by_type VARCHAR(20), -- customer, waiter
...
-- Ingredients and Stock Management
...
CREATE TABLE IF NOT EXISTS staff_users (
    ...
    role VARCHAR(50) NOT NULL, -- waiter, chef, admin
